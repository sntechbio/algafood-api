...
public class RestauranteProdutoFotoController {
    ...
    public RestauranteProdutoFotoController(CadastroProdutoService cadastroProduto, CatalogoFotoProdutoService catalogoFotoProdutoService,
                                            FotoProdutoModelAssembler fotoProdutoModelAssembler, FotoStorageService fotoStorageService) {
